...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
        ...
        public function StatsDisplay()
        {
			...
			mTextField = new TextField(50, 60, "", "Verdana", 15, 0xFF0000);
			mTextField.x = 2;
        ...
        public function update():void
        {
			...
			mTextField.text = "" + (mTotalTime > 0 ? mDrawCount-1 : mDrawCount) +
				"\n" + mFps.toFixed(mFps < 100 ? 1 : 0) + 
				"\n" + mMemory.toFixed(mMemory < 100 ? 1 : 0);
        }
