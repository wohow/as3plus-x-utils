...
package ldEasyNape
{
	...
	public class LDEasyNape
	{
		...
		public static function createDebug():ShapeDebug{
			napeDebug= new ShapeDebug(stage.fullScreenWidth, stage.fullScreenHeight);
...
//			steel：钢铁材质，
//			wood：木头材质，
			var mate:Material = new Material( Number.POSITIVE_INFINITY );
...
//			shape.fluidEnabled = true;
		...
		public static function createWrapWall():void{
			var w:Number = LDEasyNape.stage.fullScreenWidth;
			var h:Number = LDEasyNape.stage.fullScreenHeight;
			var wallthickness:Number=10;

			createBox( w / 2, -5, w , wallthickness, true);
			createBox( w / 2 , h - 21, w , wallthickness, true);
			createBox( -5, h / 2, wallthickness, h , true);
			createBox( w + 4, h / 2, wallthickness, h , true);
		}
		/**
		 * 
		 * 
